...
<div class="main-container pattern-bg mobile">
	<div class="info-container">
		...
		<button type="button" class="aa-btn blue caps">Clock in</button>
		<button type="button" class="aa-btn red caps"><span>Clock Out</span><img class="icon" src="images/warning.svg"></button>
		<button type="button" class="aa-btn green caps"><span>Clocked Out</span><img class="icon" src="images/check.svg"></button>
	</div>
	<!-- POP-UPS -->
